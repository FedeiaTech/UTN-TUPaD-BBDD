...
-- Paso 1: Eliminar el índice idx_producto_nombre si existe (para medir sin índice)
DROP INDEX IF EXISTS idx_producto_nombre ON productos;

-- Paso 2: Ejecutar la consulta de búsqueda SIN el índice 
SELECT * FROM productos WHERE nombre = 'Producto 450123';

-- Paso 3: Volver a crear el índice idx_producto_nombre
CREATE INDEX idx_producto_nombre ON productos(nombre);

-- Paso 4: Ejecutar la MISMA consulta de búsqueda CON el índice
SELECT * FROM productos WHERE nombre = 'Producto 450123';

-- Fin de la prueba de rendimiento --
